from django.shortcuts import render, redirect, get_object_or_404  # call render shortcuts
...
def book_list(request):
    ...
    books = Book.objects.all()  # Retrives all books from the database
    context = {
        'books' : books,
        'message' : 'This is FBVs' # Additional context varival
    }
